				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li <?php if($this->uri->segment(2)=="kedi"){ echo 'class="sale-noti"';} ?> >
								<a href="<?=base_url('kategori/kedi')?>">Kedi</a>
							</li>

							<li <?php if($this->uri->segment(2)=="kopek"){ echo 'class="sale-noti"';} ?> > 
								<a href="<?=base_url('kategori/kopek')?>">Köpek</a>
							</li>

							<li <?php if($this->uri->segment(2)=="tavsan"){ echo 'class="sale-noti"';} ?> >
								<a href="<?=base_url('kategori/tavsan')?>">Tavşan</a>
							</li>
